(function () {
    ...
    function add() {
      Lampa.Listener.follow('torrent_file', function (data) {
        if (data.type === 'onlong') {
          console.log("Infuse saver", "".concat(encodeURI(data.element.url)));
          data.menu.push({
            ...
            onSelect: function onSelect(a) {
              ...
              window.location.href = "infuse://x-callback-url/save?url=".concat(encodeURI(data.element.url));
            }
          }, {
            ...
            onSelect: function onSelect(a) {
              window.location.href = "vlc://".concat(data.element.url);
            }
          });
        }
      });
