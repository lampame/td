        ...
        if (data.type === 'onlong') {
          ...
          data.menu.push({
            ...
            onSelect: function onSelect(a) {
              window.location.href = "infuse://x-callback-url/save?x-success=some-app://x-callback-url/playbackDidFinish&x-error=some-app://x-callback-url/playbackDidFail&url=".concat(data.element.url);
            }
          });
        }
      });
