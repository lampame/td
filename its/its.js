(function () {
    ...
    function add() {
      Lampa.Listener.follow('torrent_file', function (data) {
        if (data.type === 'onlong') {
          console.log("TDDev-torrent_file", data);
          console.log("TDDev-torrent_file", data.element.url);
          console.log("TDDev-torrent_file", "infuse://x-callback-url/save?x-success=some-app://x-callback-url/playbackDidFinish&x-error=some-app://x-callback-url/playbackDidFail&url=" + data.element.url);
          data.menu.push({
            ...
            onSelect: function onSelect(a) {
              window.location.href = "infuse://x-callback-url/save?x-success=some-app://x-callback-url/playbackDidFinish&x-error=some-app://x-callback-url/playbackDidFail&url=".concat(encodeURIComponent(data.element.url));
            }
          });
        }
      });
