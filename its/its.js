(function () {
    ...
    function add() {
      Lampa.Listener.follow('torrent_file', function (data) {
        if (data.type === 'onlong') {
          console.log("Infuse saver", "".concat(encodeURIComponent(data.element.url)));
          data.menu.push({
            ...
            onSelect: function onSelect(a) {
              ...
              window.location.href = "infuse://x-callback-url/save?url=" + encodeURIComponent(data.element.url);
            }
          });
        }
      });
